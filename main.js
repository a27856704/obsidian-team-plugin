...
`;
var DEFAULT_MONTHLY_TEMPLATE = `# \u6708\u62A5 - {{month}}
...
var DEFAULT_SETTINGS = {
  serverUrl: "https://team.rpa.net.cn",
  wsUrl: "wss://team.rpa.net.cn/ws/collab",
  apiKey: "",
  userId: "",
  username: "",
  currentTeamId: "",
...
var TeamPluginSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("WebSocket \u5730\u5740 (\u534F\u540C\u670D\u52A1)").setDesc("\u72EC\u7ACB\u7684 WebSocket \u534F\u540C\u5730\u5740 (\u4F8B\u5982: wss://api.example.com/ws/collab)").addText(
      (text2) => text2.setPlaceholder("wss://api.example.com/ws/collab").setValue(this.plugin.settings.wsUrl).onChange(async (value) => {
        this.plugin.settings.wsUrl = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("API \u5BC6\u94A5").setDesc("\u670D\u52A1\u5668\u8BA4\u8BC1\u5BC6\u94A5").addText(
      (text2) => text2.setPlaceholder("your-api-key").setValue(this.plugin.settings.apiKey).onChange(async (value) => {
        this.plugin.settings.apiKey = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("\u7528\u6237\u540D").setDesc("\u5728\u56E2\u961F\u4E2D\u663E\u793A\u7684\u540D\u79F0").addText(
      (text2) => text2.setPlaceholder("Your Name").setValue(this.plugin.settings.username).onChange(async (value) => {
        this.plugin.settings.username = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("AI").setHeading();
    new import_obsidian.Setting(containerEl).setName("AI \u63D0\u4F9B\u5546").setDesc("\u9009\u62E9\u7528\u4E8E\u6587\u6863\u603B\u7ED3\u548C\u62A5\u544A\u751F\u6210\u7684 AI \u670D\u52A1").addDropdown(
      (dropdown) => dropdown.addOption("dmxapi", "DMXAPI (\u5168\u6A21\u578B\u4EE3\u7406)").addOption("openai", "OpenAI (GPT-4/3.5)").addOption("claude", "Claude (Anthropic)").addOption("custom", "\u81EA\u5B9A\u4E49 (OpenAI \u517C\u5BB9)").setValue(this.plugin.settings.aiProvider).onChange(async (value) => {
    ...
    new import_obsidian.Setting(containerEl).setName("AI API \u5BC6\u94A5").setDesc(this.plugin.settings.aiProvider === "dmxapi" ? "DMXAPI \u4EE4\u724C (\u4E00\u4E2A Key \u53EF\u8C03\u7528\u6240\u6709\u6A21\u578B)" : "AI \u670D\u52A1\u7684 API \u5BC6\u94A5").addText(
      (text2) => text2.setPlaceholder("sk-...").setValue(this.plugin.settings.aiApiKey).onChange(async (value) => {
    ...
    if (showEndpoint) {
      ...
      new import_obsidian.Setting(containerEl).setName("API \u7AEF\u70B9").setDesc("API \u5730\u5740 (\u7559\u7A7A\u4F7F\u7528\u9ED8\u8BA4\u5730\u5740\uFF0C\u652F\u6301\u4EE3\u7406)").addText(
        (text2) => text2.setPlaceholder(placeholder).setValue(this.plugin.settings.aiEndpoint).onChange(async (value) => {
    ...
    new import_obsidian.Setting(containerEl).setName("\u6A21\u578B").setDesc("\u4F7F\u7528\u7684 AI \u6A21\u578B\u540D\u79F0").addText(
      (text2) => text2.setPlaceholder(modelPlaceholders[this.plugin.settings.aiProvider] || "gpt-4").setValue(this.plugin.settings.aiModel).onChange(async (value) => {
    ...
    new import_obsidian.Setting(containerEl).setName("\u81EA\u52A8\u751F\u6210\u65E5\u62A5").setDesc("\u5728\u6307\u5B9A\u65F6\u95F4\u81EA\u52A8\u751F\u6210\u65E5\u62A5").addToggle(
      (toggle) => toggle.setValue(this.plugin.settings.autoGenerateDailyReport).onChange(async (value) => {
        this.plugin.settings.autoGenerateDailyReport = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("\u65E5\u62A5\u751F\u6210\u65F6\u95F4").setDesc("\u81EA\u52A8\u751F\u6210\u65E5\u62A5\u7684\u65F6\u95F4 (24\u5C0F\u65F6\u5236)").addText(
      (text2) => text2.setPlaceholder("18:00").setValue(this.plugin.settings.dailyReportTime).onChange(async (value) => {
        this.plugin.settings.dailyReportTime = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("\u65E5\u62A5\u6A21\u677F").setDesc("\u81EA\u5B9A\u4E49\u65E5\u62A5\u6A21\u677F (\u7559\u7A7A\u4F7F\u7528\u9ED8\u8BA4\u6A21\u677F)").addTextArea(
      (text2) => text2.setPlaceholder(DEFAULT_DAILY_TEMPLATE).setValue(this.plugin.settings.dailyReportTemplate).onChange(async (value) => {
        this.plugin.settings.dailyReportTemplate = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("\u6708\u62A5\u6A21\u677F").setDesc("\u81EA\u5B9A\u4E49\u6708\u62A5\u6A21\u677F (\u7559\u7A7A\u4F7F\u7528\u9ED8\u8BA4\u6A21\u677F)").addTextArea(
      (text2) => text2.setPlaceholder(DEFAULT_MONTHLY_TEMPLATE).setValue(this.plugin.settings.monthlyReportTemplate).onChange(async (value) => {
        this.plugin.settings.monthlyReportTemplate = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("Plugin sync").setHeading();
    new import_obsidian.Setting(containerEl).setName("\u540C\u6B65\u63D2\u4EF6\u5217\u8868").setDesc("\u4E0E\u56E2\u961F\u6210\u5458\u540C\u6B65\u5DF2\u5B89\u88C5\u7684\u63D2\u4EF6\u5217\u8868").addToggle(
      (toggle) => toggle.setValue(this.plugin.settings.syncPluginList).onChange(async (value) => {
        this.plugin.settings.syncPluginList = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("\u540C\u6B65\u63D2\u4EF6\u8BBE\u7F6E").setDesc("\u540C\u65F6\u540C\u6B65\u63D2\u4EF6\u7684\u914D\u7F6E\u6587\u4EF6").addToggle(
      (toggle) => toggle.setValue(this.plugin.settings.syncPluginSettings).onChange(async (value) => {
        this.plugin.settings.syncPluginSettings = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("\u6392\u9664\u7684\u63D2\u4EF6").setDesc("\u4E0D\u53C2\u4E0E\u540C\u6B65\u7684\u63D2\u4EF6 ID\uFF0C\u4F7F\u7528\u9017\u53F7\u5206\u9694").addText(
      (text2) => text2.setPlaceholder("plugin-id-1, plugin-id-2").setValue(this.plugin.settings.excludedPlugins.join(", ")).onChange(async (value) => {
        this.plugin.settings.excludedPlugins = value.split(",").map((s) => s.trim()).filter((s) => s.length > 0);
        await this.plugin.saveSettings();
      })
    );
    ...
    new import_obsidian.Setting(containerEl).setName("\u8C03\u8BD5\u6A21\u5F0F").setDesc("\u5F00\u542F\u540E\u4F1A\u5728\u63A7\u5236\u53F0\u8F93\u51FA\u8BE6\u7EC6\u65E5\u5FD7").addToggle(
...
var TeamManager = class {
  ...
  async createTeam(name, description) {
    const team = await this.request("/api/teams", "POST", {
      name,
      description
    });
  ...
  async getTeam(teamId) {
    return await this.request(`/api/teams/${teamId}`, "GET");
  }
  /**
   * Get all teams for current user
   */
  async getMyTeams() {
    return await this.request("/api/teams", "GET");
  }
  /**
   * Update team settings
   */
  async updateTeamSettings(teamId, settings) {
    return await this.request(`/api/teams/${teamId}/settings`, "PATCH", settings);
  }
  /**
  ...
  async deleteTeam(teamId) {
    var _a;
    await this.request(`/api/teams/${teamId}`, "DELETE");
    if (((_a = this.currentTeam) == null ? void 0 : _a.id) === teamId) {
      this.currentTeam = null;
    }
  }
  // ========== Member Operations ==========
  ...
  async inviteMember(teamId, email, role = "member") {
    return await this.request(`/api/teams/${teamId}/invitations`, "POST", {
      email,
      role
    });
  }
  ...
  async acceptInvitation(invitationId) {
    return await this.request(`/api/invitations/${invitationId}/accept`, "POST");
  }
  /**
   * Reject team invitation
   */
  async rejectInvitation(invitationId) {
    await this.request(`/api/invitations/${invitationId}/reject`, "POST");
  }
  /**
   * Get pending invitations for current user
   */
  async getMyInvitations() {
    return await this.request("/api/invitations", "GET");
  }
  /**
   * Remove a member from team
   */
  async removeMember(teamId, userId) {
    await this.request(`/api/teams/${teamId}/members/${userId}`, "DELETE");
  }
  /**
   * Update member role
   */
  async updateMemberRole(teamId, userId, role) {
    return await this.request(`/api/teams/${teamId}/members/${userId}`, "PATCH", {
      role
    });
  }
  /**
  ...
  async leaveTeam(teamId) {
    var _a;
    await this.request(`/api/teams/${teamId}/leave`, "POST");
    if (((_a = this.currentTeam) == null ? void 0 : _a.id) === teamId) {
      this.currentTeam = null;
    }
  }
  ...
  async getTeamDocuments(teamId) {
    return await this.request(`/api/collab/${teamId}/files`, "GET");
  }
  /**
   ...
   */
  async renameTeamDocument(teamId, documentId, newPath) {
    return await this.request(`/api/collab/${teamId}/files/${documentId}`, "PATCH", {
      path: newPath
    });
  }
  /**
   ...
   */
  async deleteTeamDocument(teamId, documentId) {
    await this.request(`/api/collab/${teamId}/files/${documentId}`, "DELETE");
  }
  /**
   * Get histories of a document
   */
  async getTeamDocumentHistories(teamId, documentId) {
    return await this.request(`/api/collab/${teamId}/files/${documentId}/history`, "GET");
  }
  /**
   * Get a specific history snapshot full content
   */
  async getTeamDocumentHistorySnapshot(teamId, documentId, historyId) {
    return await this.request(`/api/collab/${teamId}/files/${documentId}/history/${historyId}`, "GET");
  }
};
...
var PluginSync = class {
   ...
   */
  async sharePluginConfig(teamId) {
   ...
   */
  async getTeamPluginConfig(teamId) {
    return await this.request(`/api/teams/${teamId}/plugins`, "GET");
  }
  /**
   * Install plugins from sync package
   * Note: This will only install from community plugins, not arbitrary sources
   */
  async installPluginsFromPackage(syncPackage) {
    const installed = [];
    const failed = [];
    const skipped = [];
   ...
   */
  generatePluginListMarkdown(plugins) {
    let md = "# \u63D2\u4EF6\u5217\u8868\n\n";
...
var Collaboration = class {
  constructor(app, settings) {
    ...
    this.syncedVersions = /* @__PURE__ */ new Map();
    this.app = app;
    this.settings = settings;
  }
  updateSettings(settings) {
...
var CollabEditor = class {
  constructor(app, plugin, settings) {
    ...
    this.plugin = plugin;
    this.settings = settings;
    this.collabCompartment = new import_state.Compartment();
  ...
  get activeFilePath() {
    var _a;
    return ((_a = this.activeSession) == null ? void 0 : _a.file.path) || null;
  }
  /**
   * 开始协同编辑当前打开的文件
   */
  async startCollab(teamId, file) {
    var _a;
    ...
    (_a = this.onStatusChange) == null ? void 0 : _a.call(this, "connecting", `\u6B63\u5728\u8FDE\u63A5\u534F\u540C...`);
    const ydoc = new Doc();
    ...
    provider.on("status", (event) => {
      ...
      if (event.status === "connected") {
        (_a2 = this.onStatusChange) == null ? void 0 : _a2.call(this, "connected", `\u534F\u540C\u7F16\u8F91\u4E2D: ${file.basename}`);
      } else if (event.status === "disconnected") {
        (_b = this.onStatusChange) == null ? void 0 : _b.call(this, "disconnected", "\u8FDE\u63A5\u65AD\u5F00\uFF0C\u6B63\u5728\u91CD\u8FDE...");
      }
    });
    ...
    provider.on("connection-close", (event) => {
      console.warn("[CollabEditor] WebSocket \u8FDE\u63A5\u5173\u95ED:", event == null ? void 0 : event.code, event == null ? void 0 : event.reason);
      if ((event == null ? void 0 : event.code) === 4001 && this.onAuthFailed) {
        this.onAuthFailed();
      }
    });
    ...
    if (ytext.length === 0) {
      ...
      const localContent = editorView ? editorView.state.doc.toString() : await this.app.vault.read(file);
   ...
   */
  bindToEditor(file, ydoc, provider) {
    const ytext = ydoc.getText("codemirror");
    const undoManager = new UndoManager(ytext);
    let isCleaned = false;
    let retryTimer = null;
    const doInject = (editorView2) => {
      if (isCleaned)
        return;
      const currentDoc = editorView2.state.doc.toString();
...
var BaseAIProvider = class {
   ...
   */
  async generateReportFromSummaries(summaries, stats, options) {
    const prompt = this.buildReducePrompt(summaries, stats, options);
    return await this.chatWithProvider(prompt);
  }
  buildSummarizePrompt(content, options) {
    const lang = (options == null ? void 0 : options.language) === "en" ? "English" : "\u4E2D\u6587";
    const style = (options == null ? void 0 : options.style) || "brief";
...
${(options == null ? void 0 : options.maxLength) ? `\u603B\u7ED3\u4E0D\u8D85\u8FC7${options.maxLength}\u5B57\u3002` : ""}

\u5185\u5BB9\uFF1A
${content}`;
  }
  buildReportPrompt(documents, options) {
    const lang = (options == null ? void 0 : options.language) === "en" ? "English" : "\u4E2D\u6587";
    const typeMap = {
      "daily": "\u65E5\u62A5",
      "weekly": "\u5468\u62A5",
    ...
    const reportType = typeMap[(options == null ? void 0 : options.type) || "daily"];
    const docSummaries = documents.map(
      (doc2) => `\u6587\u6863\uFF1A${doc2.title}
\u8DEF\u5F84\uFF1A${doc2.path}
\u5185\u5BB9\u6458\u8981\uFF1A${doc2.content.substring(0, 500)}...`
    ).join("\n\n---\n\n");
    return `\u8BF7\u6839\u636E\u4EE5\u4E0B\u6587\u6863\u5185\u5BB9\uFF0C\u751F\u6210\u4E00\u4EFD${reportType}\u3002\u4F7F\u7528${lang}\u8F93\u51FA\u3002

\u8981\u6C42\uFF1A
1. \u603B\u7ED3\u4E3B\u8981\u5DE5\u4F5C\u5185\u5BB9\u548C\u6210\u679C
2. \u63D0\u53D6${(options == null ? void 0 : options.highlightCount) || 3}\u4E2A\u91CD\u70B9\u5DE5\u4F5C\u4EAE\u70B9
3. ${(options == null ? void 0 : options.includeStats) ? "\u5305\u542B\u5DE5\u4F5C\u91CF\u7EDF\u8BA1" : ""}
4. \u8BED\u8A00\u8981\u4E13\u4E1A\u3001\u7B80\u6D01
...
${docSummaries}`;
   ...
   */
  buildReducePrompt(summaries, stats, options) {
    const lang = (options == null ? void 0 : options.language) === "en" ? "English" : "\u4E2D\u6587";
    const typeMap = {
      "daily": "\u65E5\u62A5",
      "weekly": "\u5468\u62A5",
...
var OpenAIProvider = class extends BaseAIProvider {
  ...
  async generateReport(documents, options) {
...
var Summarizer = class {
   ...
   */
  async summarizeFile(file, options) {
    if (!this.provider) {
   ...
   */
  async mapReduceReport(files, stats, options, onProgress) {
    if (!this.provider) {
      throw new Error("AI provider not configured");
    }
    ...
    for (let i = 0; i < files.length; i++) {
      const file = files[i];
      onProgress == null ? void 0 : onProgress(i + 1, total, file.basename);
      const content = await this.app.vault.cachedRead(file);
    ...
    onProgress == null ? void 0 : onProgress(total, total, "\u6B63\u5728\u751F\u6210\u62A5\u544A...");
   ...
   */
  async summarizeFullDocument(content, title) {
    if (!this.provider)
      throw new Error("AI provider not configured");
...
${chunkSummaries.map((s, i) => `\u7B2C${i + 1}\u90E8\u5206\uFF1A${s}`).join("\n")}`;
   ...
   */
  async generateReportFromFiles(files, options) {
    if (!this.provider) {
      throw new Error("AI provider not configured");
    }
...
var DailyReport = class {
   ...
   */
  async generateReport(startTime, endTime, onProgress) {
   ...
   */
  getModifiedFiles(startTime, endTime) {
   ...
   */
  async calculateStats(files, startTime) {
    let totalWords = 0;
    let newDocuments = 0;
   ...
   */
  generateBasicSummary(documents) {
...
var MonthlyReport = class {
   ...
   * Generate basic summary without AI
   */
  generateBasicSummary(documents, stats) {
    if (documents.length === 0) {
      return "\u672C\u6708\u6682\u65E0\u6587\u6863\u66F4\u65B0\u3002";
    }
   ...
   */
  generateBasicHighlights(documents) {
    return documents.slice(0, 5).map(
      (doc2) => `\u5B8C\u6210\u6587\u6863\u300C${doc2.title}\u300D\uFF0C\u5171 ${doc2.wordCount} \u5B57`
    );
  }
  /**
...
var ReportModal = class extends import_obsidian10.Modal {
  ...
  async generatePreview(previewEl, progressDiv) {
    try {
      const onProgress = (current, total, docTitle) => {
        if (docTitle === "\u6B63\u5728\u751F\u6210\u62A5\u544A...") {
          progressDiv.textContent = `\u{1F4DD} \u6B63\u5728\u6C47\u603B\u751F\u6210\u6700\u7EC8\u62A5\u544A...`;
        } else {
          progressDiv.textContent = `\u{1F50D} \u5206\u6790\u6587\u6863 ${current}/${total}\uFF1A${docTitle || ""}`;
        }
      };
      let report;
...
var HistoryModal = class extends import_obsidian14.Modal {
  ...
  async onOpen() {
    const { contentEl } = this;
    contentEl.empty();
    contentEl.createEl("h2", { text: `\u{1F4DC} \u6587\u6863\u65F6\u5149\u673A: ${this.docPath}` });
...
var TeamView = class extends import_obsidian15.ItemView {
  ...
  getTeamWebSocketUrl() {
    var _a;
    let base;
    if ((_a = this.plugin.settings.wsUrl) == null ? void 0 : _a.trim()) {
  ...
  logTeamWs(action, detail) {
    const entry = { time: (/* @__PURE__ */ new Date()).toISOString(), interface: "ws/team", action, ...detail };
    console.log(`[TeamCollab] ${JSON.stringify(entry)}`);
  }
  /** 连接团队事件 WebSocket，收到 team_drive_changed 时自动刷新 */
  connectTeamWebSocket() {
    var _a;
    if (!this.currentTeam || !this.plugin.settings.apiKey)
      return;
    if (((_a = this.teamWs) == null ? void 0 : _a.readyState) === WebSocket.OPEN && this.teamWsTeamId === this.currentTeam.id)
      return;
    this.disconnectTeamWebSocket();
    ...
    const tryConnect = () => {
      ...
      try {
        ...
        ws.onopen = () => {
          var _a2, _b;
          this.reconnectTimer = null;
          this.teamWsTeamId = (_b = (_a2 = this.currentTeam) == null ? void 0 : _a2.id) != null ? _b : null;
              ...
              for (const { from: from2, to } of renamed) {
                ...
                if (file && file instanceof import_obsidian15.TFile) {
                  try {
                    ...
                    this.plugin.pendingRemoteRenames.delete(from2);
                  }
                }
              }
              this.render();
  ...
  async renderTeamSelector(container) {
    try {
      ...
      if (invitations && invitations.length > 0) {
        ...
        inviteDiv.createEl("h5", { text: `\u{1F4EC} \u4F60\u6709 ${invitations.length} \u4E2A\u5F85\u5904\u7406\u9080\u8BF7` });
  ...
  async renderTeamDrive(container) {
    if (!this.currentTeam)
      return;
    const driveDiv = container.createDiv("team-drive");
    driveDiv.createEl("h5", { text: "\u56E2\u961F\u6587\u4EF6\u5E93 \u{1F4C1}" });
    ...
    try {
      ...
      const teamPrefix = `\u56E2\u961F\u4E91\u76D8/${this.currentTeam.name}`;
      for (const doc2 of this.teamDocs) {
        if (!this.app.vault.getAbstractFileByPath(doc2.path)) {
          ...
          await this.app.vault.create(doc2.path, "");
        }
      }
...
var TeamPlugin = class extends import_obsidian17.Plugin {
  constructor() {
    ...
    this.pendingRemoteRenames = /* @__PURE__ */ new Set();
  }
  async onload() {
    ...
    this.registerEvent(
      this.app.vault.on("rename", async (file, oldPath) => {
        ...
        try {
          ...
          const doc2 = docs.find((d) => d.path === oldPath);
          if (!doc2)
            return;
...
`);
  ...
  setupAutoDailyReport() {
    if (!this.settings.autoGenerateDailyReport)
      return;
